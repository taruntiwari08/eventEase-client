...
function Home() {
  ...
  return (
    ...
    <label title="Top Rated Events"> 
      <section className="mt-0 p-6 pl-28">
          ...
          {Object.values(events).length > 0 ? (
            <>
              ...
              <div className="col-span-full flex justify-center mt-6">
                          <Link to="/events">
                            <button
                            className="lg:w-45 text-sm cursor-pointer transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
                              View More Events
                            </button>
                          </Link>
              </div>
