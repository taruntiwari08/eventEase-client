  ...
  return (
    <div className="flex justify-center items-center h-screen ">
      <form
        ...
        className="bg-white/90 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-96 border bg-gradient-to-br from-blue-500 via-slate-200 to-blue-500 border-gray-200"
      >
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <span className="text-indigo-600 font-semibold hover:underline cursor-pointer" onClick={() => navigate("/signup")}>
            Sign up
          </span>
        </p>
      </form>
